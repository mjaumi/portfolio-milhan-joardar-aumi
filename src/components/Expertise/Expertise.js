    ...
    return (
        <section className='relative border-t-4 border-accent/50 section fp-responsive md:h-screen'>
            <div className='sticky z-30 bg-primary w-full h-full overflow-hidden'>
                <h1 className={`hidden md:block absolute text-accent opacity-20 text-4xl md:text-8xl font-black -rotate-90 left-0 -translate-x-1/3 md:translate-x-0 duration-500 ${currentSection === 'Expertise' ? 'top-[42%] md:top-[45%] -translate-y-1/2' : 'top-[150%]'}`}>Expertise</h1>
                <div className={`w-[90%] md:w-[65%] md:mt-0 mx-auto h-full flex flex-col justify-center items-center pb-10 md:pb-0 ${currentSection === 'Expertise' ? 'md:animate-bottom-top-fade-in border-l-2 border-accent' : 'md:opacity-0'}`}>
